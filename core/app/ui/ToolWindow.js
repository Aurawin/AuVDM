coAppUI.App.Components.ToolWindow = {
  Version        : new Version(2014,9,18,2),
  Title          : new Title("Aurawin Tool Window","ToolWindow"),
  ...
  Header         : coAppKit.Dependencies.Create(coAppUI.App,'/core/app/ui/ToolWindow.js',coAppKit.PreLoaded),
  debugToConsole : true,
