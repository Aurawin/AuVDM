...
coAppUI.App.Components.Glyph = {
  Version        : new Version(2013,5,18,24),
  Title          : new Title("Aurawin UI Glyph","Glyph"),
  ...
  Header         : coAppKit.Dependencies.Create(coAppUI.App,'/core/app/ui/Glyph.js',coAppKit.PreLoaded),
  debugToConsole : true,
