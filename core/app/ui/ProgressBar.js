coAppUI.App.Components.ProgressBar = {
  Version        : new Version(2013,5,18,14),
  Title          : new Title("Aurawin UI Progress Bar","ProgressBar"),
  ...
  Header         : coAppKit.Dependencies.Create(coAppUI.App,'/core/app/ui/ProgressBar.js',coAppKit.PreLoaded),
  debugToConsole : true,
