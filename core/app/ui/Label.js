coAppUI.App.Components.Label = {
  Version        : new Version(2013,12,16,23),
  Title          : new Title("Aurawin UI Label","Label"),
  ...
  Header         : coAppKit.Dependencies.Create(coAppUI.App,'/core/app/ui/Label.js',coAppKit.PreLoaded),
  debugToConsole : true,
  Create         : function(aOwner,aParent,sName,sClass,sCaption){
    ...
    l.setFontSize=function(height){
      this.Container.style.fontSize=height+"px";
      this.Container.style.lineHeight=(height-2)+"px";
    };
    ...
    l.Container.onclick=function(){
      if (this.Owner.onClick) this.Owner.onClick(this);
    };
    l.Conseal=function(){
      this.Hide();
      this.Hidden=true;
