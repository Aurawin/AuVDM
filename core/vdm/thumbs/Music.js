coThumbs.App.Components.Music = {
  Version        : new Version(2013,5,18,3),
  Title          : new Title("Music Thumbnails","Music"),
  ...
  Header         : coAppKit.Dependencies.Create(coThumbs.App,'/core/vdm/thumbs/Music.js',coAppKit.PreLoaded),
  Handles        : ["mp3","oog"],
  debugToConsole : true,
